...
class Plan:
    def __init__(self, name):
        ...
        self.courses = [[[], [], []],
                        ...
                        [[], [], []],
                        [[], [], []]]
    def add(self, course, year, quarter):
        self.courses[year][quarter].append(course)

p = Plan("foo")
p.courses = [[[bien001, chem001a, engl001a, math009a],
...
all_prereqs_OK = True
for y, year in enumerate(p.courses):
    print(f"year {y}")
...
print("all_prereqs_OK:", all_prereqs_OK)
